 ...
 */
class FanoutSettings : Serializable, Cloneable {
  ...
  @JvmField
  var maxMillisecondsPerPin: Long? = null
   ...
   * sufficient.
   */
  public override fun clone(): FanoutSettings {
    try {
      return super.clone() as FanoutSettings
